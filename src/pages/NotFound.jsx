  ...
  return (
    <main className="not-found-page">
      ...
      <section className="not-found-card">
        <div className="not-found-icon"><SearchX size={34} strokeWidth={2.2} /></div>
        ...
        <div className="not-found-actions">
          <Link className="not-found-primary" to="/"><Home size={18} />Voltar ao início</Link>
          <button className="not-found-secondary" type="button" onClick={() => window.history.back()}><ArrowLeft size={18} />Página anterior</button>
        </div>
